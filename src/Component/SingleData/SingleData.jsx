...
const SingleData = (props) => {
    ...
    const { id, image, description, features, name, published_in } = props.singleData


    return (
        <div>
            <div className="card w-[100%] h-[100%] bg-base-100 shadow-2xl">
                <figure><img className='w-[100%] h-[100%] rounded-lg' src={image} alt="Shoes" /></figure>
                <div className="card-body">
                    <h2 className="card-title">Features</h2>
                    {
                        features.map((feature, index) => <p className='text-left'>
                            {index + 1}. {feature}
                        </p>)
                    }
                    <hr className='border border-black-50 mt-5 mb-3' />
